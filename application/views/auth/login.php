...
<body class="bg-gradient-success">
	...
	<!-- Outer Row -->
		<h3 class="text-center mt-5	text-white">
			Selamat Datang di Aplikasi EBK <br> 
			<b> SMK Negeri 5 Kendal </b>
		</h3>
...
<?php endif ?>
									...
									<form class="user" action="<?= base_url('auth/login') ?>" method="POST">
										<div class="form-group">
											<input type="text" name="username" class="form-control form-control-user" autofocus placeholder="Masukkan Id User" required>
										</div>
										<div class="form-group">
